...
% including the path of all functions and classes into this main file
addpath("src");

%% taking the image as a variable to pass to the FindingOperations class
image = 'testing_images/two_minus_one.png'; 

% asking the user for the number of digits on each side of the arithmetic operation
...
% or FindingOperationsTwoDigit classes to find the numbers in the image provided
...
fprintf("Past results displayed")
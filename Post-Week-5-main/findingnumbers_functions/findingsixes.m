            ...
            if(matrix(row, column)==0)
                ...
                while ~test
                    if(stage==1)  % moving down the right branch of the 6 from the initial starting position
                        if(matrix(row+xcrement_var, column+2*xcrement_var)==0 && xcrement_var < 5)
                    ...
                    elseif(stage == 2)
                        if(matrix(row+xcrement_var, column-xcrement_var)==0 && xcrement_var < 14)
                            xcrement_var = xcrement_var + 1;
...
%                             fprintf(" %d, %d", new_row, new_column);
                    ...
                    elseif(stage == 3)
                        if(matrix(new_row+xcrement_var, new_column)==0 && xcrement_var < 33)
                            xcrement_var = xcrement_var + 1;
...
%                             fprintf(" %d, %d", new_row+xcrement_var, new_column+xcrement_var);
                    ...
                    elseif(stage==5)
                        if(matrix(new_row, new_column+xcrement_var)==0 && xcrement_var < 10)
                            xcrement_var = xcrement_var + 1;
                        elseif(xcrement_var==10)
                            stage = stage + 1;
                            new_column = new_column + xcrement_var;
                            ...
                            fprintf("Not a six\n");
%                             fprintf(" %d, %d", new_row, new_column+xcrement_var);
                            sixes = 0;
                            return;
                        end
                    ...
                    elseif(stage == 9)
                        if(matrix(new_row, new_column-xcrement_var)==0 && xcrement_var < 17)
                            xcrement_var = xcrement_var + 1;

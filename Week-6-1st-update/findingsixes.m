                ...
                while ~test
                    ...
                    elseif(stage==11) % moving 6 rows down and 6 columns left and if this test passes and the pixel to the left of it is still black
                        ...
                        elseif(xcrement_var==6)
                            ...
                            new_column = new_column + xcrement_var;
                            xcrement_var = 0;
                            if(matrix(new_row, new_column-1==0)) % if the pixel to the left of the terminal point of the vector is still black we have passed all the vector tests
                                stage = stage + 1;
                            end
                    else % as we have passed all the vector tests we can end the while loop
                        test = true;
                    end          
                end
                
                % we passed all tests so we can return that a six was found to the user and the calling function
                sixes = 1;

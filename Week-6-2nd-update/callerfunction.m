...
function matrices = callerfunction(matrix)
    ...
    num_columns_1 = round(0.5 * columns)-20; % finding the boundary for the first matrix of the first third of the image
    ...
    num_columns_2 = round(0.5 * columns)+17; % finding the boundary for the second matrix of the second third of the image

...
function submatrix = submatrices_maker(original_matrix, leftboundary, rightboundary)
    ...
    catch % if the index of the matrix are negative or non natural numbers we catch this errror
        fprintf("THE DIMENSIONS OF THE MATRICES PRODUCED ARE INCORRECT\n");
        return;
    end
end